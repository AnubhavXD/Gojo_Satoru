...
Use this to make Akari feel a bit more customised! (only works in filters/notes)
...
Akari Watanabe supports a large number of formatting options to make your messages more expressive. Take a look by clicking the buttons below!""",
